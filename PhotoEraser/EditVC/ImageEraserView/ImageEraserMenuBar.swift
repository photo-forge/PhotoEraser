...
public protocol ImageEraserMenuBarDelegate {
...
class ImageEraserMenuBar: UIView {
    
    var delegate: ImageEraserMenuBarDelegate!
    ...
    @objc func crossButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageEraserMenuBar_CrossButtonTapped()
        }
    }
    ...
    @objc func tickButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageEraserMenuBar_TickButtonTapped()
        }
    }
    ...
    @objc func undoButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageEraserMenuBar_UndoButtonTapped()
        }
    }
    ...
    @objc func redoButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageEraserMenuBar_RedoButtonTapped()
        }
    }
