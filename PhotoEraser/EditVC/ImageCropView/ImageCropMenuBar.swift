...
public protocol ImageCropMenuBarDelegate {
...
class ImageCropMenuBar: UIView {
    
    var delegate: ImageCropMenuBarDelegate!
    ...
    @objc func crossButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageCropMenuBar_CrossButtonTapped()
        }
    }
    ...
    @objc func tickButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageCropMenuBar_TickButtonTapped()
        }
    }
    ...
    @objc func undoButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageCropMenuBar_UndoButtonTapped()
        }
    }
    ...
    @objc func redoButtonTapped() {
        ...
        if (delegate != nil) {
            delegate.imageCropMenuBar_RedoButtonTapped()
        }
    }
